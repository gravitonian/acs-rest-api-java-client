...
public class Node {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, nodeType, isFolder, isFile, isLocked, modifiedAt, modifiedByUser, createdAt, createdByUser, parentId, isLink, content, aspectNames, properties, allowableOperations, path, permissions);
  }
